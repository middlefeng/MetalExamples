...
public:
    ...
    virtual void AddTextureCoord(size_t sourceIndex, const std::vector<float>& texCoordBuffer) = 0;
...
public:
    ...
    virtual void AddTextureCoord(size_t sourceIndex, const std::vector<float>& texCoordBuffer) override;
